...
function DashboardPage() {
  ...
  const isLoading = tasksLoading || projectsLoading || (isManager && leadsLoading);
  ...
  return (
    <div className="p-6 space-y-8">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <div
          className="lg:col-span-2 space-y-6 animate-[fade-up_0.4s_ease-out_both]"
        ...
        <div
          className="space-y-6 animate-[fade-up_0.4s_ease-out_both]"
