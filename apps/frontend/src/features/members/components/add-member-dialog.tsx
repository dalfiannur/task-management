            ...
            candidates.map((u) => (
              <li key={u.id}>
                <button
                  ...
                  className="flex w-full items-center gap-3 rounded-lg px-2 py-2 text-left transition-colors [transition-duration:var(--duration-fast)] hover:bg-surface-hover disabled:opacity-50"
                >
